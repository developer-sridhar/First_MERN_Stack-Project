    ...
    <div className='px-4 lg:px-24 bg-teal-100 flex items-center'>
      <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
        ...
        <div className='md:w-1/2 space-y-8'>
          <h2 className='text-4xl font-bold leading-snug text-B'>Buy Books <span className='text-blue-700'>for the Best Prices</span><br />Learn<span className='text-blue-700'> from Your Books</span><br /> Sell Your Books <span className='text-blue-700'>for the Best Prices</span></h2>
          ...
          <div>
            ...
            <button className='bg-blue-700  px-6 py-2 text-white font-medium hover:bg-blue-900 transition-all ease-in duration-150'>Search</button>
          </div>
        </div>
